    ...
    <div class="listings-grid" id="listingsGrid">
        ...
        <?php else: ?>
            ...
            <div class="listing-card" data-category="<?php echo htmlspecialchars($listing['category']); ?>">
                ...
                <?php else: ?>
                    <div class="listing-image" style="display: flex; align-items: center; justify-content: center; font-size: 50px; color: #999; background: #f0f0f0;">no image</div>
                <?php endif; ?>
                ...
                <div class="listing-content">
                    ...
                    <div class="seller-info" style="display: flex; align-items: center; justify-content: space-between; padding-top: 5px;">
                        ...
                        <?php else: ?>
                            <span class="seller-badge unverified" style="font-size: 11px; color: red;">Unverified</span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
