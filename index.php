    ...
    <div class="listings-grid" id="listingsGrid">
        ...
        <?php else: ?>
            ...
            <div class="listing-card" data-category="<?php echo $categorySlug; ?>">
                ...
                <?php else: ?>
                    <div class="listing-image" style="display: flex; align-items: center; justify-content: center; font-size: 50px; color: #999; background: #f0f0f0;">no image yet</div>
                <?php endif; ?>
                ...
                <div class="listing-content">
                    ...
                    <?php else: ?>
                        <span class="seller-badge unverified"style=" color:red" ;>Unverified</span>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
